...
public class FLogin extends javax.swing.JFrame {
 ...
 String username = jtxtUsername.getText().trim();
        ...
        User user = Controller.getInstance().getUser(username, password);
        Session.currentUser = user;
            dispose();
            JFrame maiin = new FMain();
            maiin.setTitle("Korisnik" +  Session.currentUser.getFirstname() + "" + user.getLastname() + "je ulogovan");
            maiin.setVisible(true);
        } catch (Exception e) {
